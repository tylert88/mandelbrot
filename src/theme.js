...
module.exports = function(options) {
  ...
  theme.addRoute("/current", { redirect: "/" });
    ...
    app.components.flatten().each(comp => {
      params = params.concat(
        comp
          ...
          .toArray()
          .map(res => {
            return { handle: comp.handle, asset: res.base };
          })
      );
    });
